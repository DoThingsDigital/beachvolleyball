  ...
  return (
    <form action={action} className="flex flex-wrap items-end gap-2">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input id="preview-date" name="date" type="date" required />
      </div>
      <div className="flex flex-col gap-1">
        <Label htmlFor="preview-start">Startzeit</Label>
        <Input id="preview-start" name="startTime" type="time" required />
      </div>
      <div className="flex flex-col gap-1">
      ...
      <label className="flex items-center gap-2 py-2 text-sm" htmlFor="preview-member">
        <input id="preview-member" name="isMember" type="checkbox" className="size-4" />
        Mitglied
      </label>
